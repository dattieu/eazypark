...
public class Constant {
	...
	public static final String INVALID_COORDINATE = "Invalid coordinate";
	public static final String INVALID_PARK = "Invalid park";
	...
	public static final String ILLEGAL_REQUEST_PARAMS = "Illegal request paramameters";
